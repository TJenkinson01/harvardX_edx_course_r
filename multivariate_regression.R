...
# stratification and sultivariate regression
...
# lse can be strongly correlated, which can be seen using this code:
lse %>% summarize(cor(beta_0, beta_1))

# correlation depends on how the predictors are defined or transformed

# standardise the father heights, which changes "xi" to "xi - x bar".
B <- 1000
N <- 50
lse <- replicate(B, {
  sample_n(galton_heights, N, replace = TRUE) %>%
...
# plot in 2d at a set value for beta 0 (input value as preferred)
